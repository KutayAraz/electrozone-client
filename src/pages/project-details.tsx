    ...
    <div className="page-spacing">
      ...
      <div className="mb-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg bg-indigo-50 p-4 border border-indigo-100">
            ...
            <p className="text-sm text-indigo-700">Optimized for desktop and mobile experiences</p>
          </div>
      ...
      <div className="rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-6 border border-blue-100">
        ...
        <p className="text-gray-600 mb-4">
          Thank you for exploring Electrozone! If you have any questions about the project or would
