...
const Checkout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-2 xs:p-6">
      <div className="max-w-screen-xl mx-auto hover:bg-">
        ...
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="flex flex-col flex-1 bg-white px-4 py-4 rounded-md shadow-md font-[500] mt-4 md:mt-0 text-gray-700 md:ml-5 md:max-w-sm min-w-[300px]">
            ...
            <button
              ...
              }  text-white px-6 py-2 mt-2 rounded-md shadow-md  transition-colors flex mx-auto xs:mx-0`}
