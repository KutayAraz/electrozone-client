...
export const ProductDesktopLayout = ({
  ...
  const modifiedCategory = category ? capitalizeWords(category.replace(/_/g, " ")) : "";
  const modifiedSubcategory = subcategory ? capitalizeWords(subcategory.replace(/_/g, " ")) : "";
    ...
    <div className="flex flex-col">
      ...
      <div className="mb-2 flex h-[700px] w-full">
        ...
        <div className="m-auto flex h-[640px] w-1/4 shrink-0 flex-col justify-evenly rounded-md border-1 border-gray-300 px-2 py-6 text-center lg:w-[30%] lg:justify-center lg:space-y-3">
          <div className="self-end mr-4 mb-6">
            <WishlistHeart
